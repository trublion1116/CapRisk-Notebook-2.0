...
export const ptBR = {
  ...
  sources: {
    ...
    savedAsNote: "Salvo no caderno",
    saveAsNoteFailed: "Falha ao salvar como nota",
    notebookRequired: "Nenhum caderno disponível. Adicione a fonte a um caderno primeiro",
    refGoSource: "Ver na fonte",
    highlightLocated: "Localizado na fonte",
