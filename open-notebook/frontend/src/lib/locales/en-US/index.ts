export const enUS = {
  ...
  sources: {
    ...
    savedAsNote: "Saved to notebook",
    saveAsNoteFailed: "Failed to save as note",
    notebookRequired: "No notebook available. Add this source to a notebook first",
    refGoSource: "View in source",
    highlightLocated: "Located in source",
