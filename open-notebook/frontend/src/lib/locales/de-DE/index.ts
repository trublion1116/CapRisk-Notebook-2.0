...
export const deDE = {
  ...
  sources: {
    ...
    savedAsNote: "Im Notizbuch gespeichert",
    saveAsNoteFailed: "Speichern als Notiz fehlgeschlagen",
    notebookRequired: "Kein Notizbuch vorhanden. Fügen Sie die Quelle zuerst zu einem Notizbuch hinzu",
    refGoSource: "In Quelle anzeigen",
    highlightLocated: "In Quelle lokalisiert",
  ...
  chat: {
    ...
    toolCallArgs: "Argumente",
    toolCallResult: "Ergebnis",
  },
  searchPage: {
    askAndSearch: "Fragen und Suchen",
