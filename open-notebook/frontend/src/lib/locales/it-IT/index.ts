...
export const itIT = {
  ...
  sources: {
    ...
    savedAsNote: "Salvato nel taccuino",
    saveAsNoteFailed: "Salvataggio come nota non riuscito",
    notebookRequired: "Nessun taccuino disponibile. Aggiungi prima la fonte a un taccuino",
    refGoSource: "Vedi nella fonte",
    highlightLocated: "Localizzato nella fonte",
