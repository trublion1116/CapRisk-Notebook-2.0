...
export const bnIN = {
  ...
  sources: {
    ...
    saveAsNote: "নোট হিসেবে সংরক্ষণ করুন",
    savedAsNote: "নোটবুকে সংরক্ষিত হয়েছে",
    saveAsNoteFailed: "নোট হিসেবে সংরক্ষণ ব্যর্থ হয়েছে",
    notebookRequired: "কোনো নোটবুক নেই। প্রথমে উৎসটি একটি নোটবুকে যোগ করুন",
    refGoSource: "উৎসে দেখুন",
    highlightLocated: "উৎসে অবস্থান নির্ধারিত",
  ...
  chat: {
    ...
    toolCallArgs: "আর্গুমেন্ট",
    toolCallResult: "ফলাফল",
  },
  searchPage: {
    askAndSearch: "জিজ্ঞাসা ও অনুসন্ধান",
