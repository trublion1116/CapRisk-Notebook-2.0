...
export const esES = {
  ...
  sources: {
    ...
    savedAsNote: "Guardado en el cuaderno",
    saveAsNoteFailed: "Error al guardar como nota",
    notebookRequired: "No hay cuaderno disponible. Añade la fuente a un cuaderno primero",
    refGoSource: "Ver en la fuente",
    highlightLocated: "Localizado en la fuente",
