...
export const ruRU = {
  ...
  sources: {
    ...
    savedAsNote: "Сохранено в записную книжку",
    saveAsNoteFailed: "Не удалось сохранить как заметку",
    notebookRequired: "Нет записных книжек. Сначала добавьте источник в записную книжку",
    refGoSource: "Показать в источнике",
    highlightLocated: "Найдено в источнике",
  ...
  chat: {
    ...
    toolCallArgs: "Аргументы",
    toolCallResult: "Результат",
  },
  searchPage: {
    askAndSearch: "Запрос и поиск",
