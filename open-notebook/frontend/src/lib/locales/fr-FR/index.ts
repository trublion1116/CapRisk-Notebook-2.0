...
export const frFR = {
  ...
  sources: {
    ...
    saveAsNote: "Enregistrer en note",
    savedAsNote: "Enregistré dans le carnet",
    saveAsNoteFailed: "Échec de l'enregistrement en note",
    notebookRequired: "Aucun carnet disponible. Ajoutez d'abord la source à un carnet",
    refGoSource: "Voir dans la source",
    highlightLocated: "Localisé dans la source",
