...
- 重要性: <对资金/风险判断意味着什么，高/中/低>
- 出处: <该候选所属的章与本节标题 + 页码，如 "I. Progress and peril / Box A: ... (p.18)"。\
页码从 read_section 返回文本中的 [第N页] 标记读取（引用所在段落最近的页标记）>
...
（总览索引表 + 编号观点 + References 出处索引 + 图文混排）——把所有有增量的候选都\
端上来，不要自行砍到过少。\
"""
